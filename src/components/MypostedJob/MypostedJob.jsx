...
const MypostedJob = () => {
    ...
    const { data, isLoading, isFetching, refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await axios.get(`https://job-city-server-b4b24onqc-yeasins-projects-c520e666.vercel.app/api/v1/getAddedJobsData?email=${user.email}`, {
    ...
    // useefect start
    // useEffect(()=>{
    //     axios.get("https://job-city-server-b4b24onqc-yeasins-projects-c520e666.vercel.app/api/v1/getAddedJobsData",{
    //         withCredentials:true
    //     })
